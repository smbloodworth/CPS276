...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'sbloodworth';//this will be your WCC username
      $dbUsr = 'sbloodworth';//this will be your WCC username
      $dbPass = '3zvJ76E7J42j';//this will be the password found in the video.
